...
class BagOfWords(object):
    ...
    def __init__(self):
        ''' Description: total number of (non distinct) words '''
        self.__number_of_words = 0
        ''' Description: key value pair of word to count '''
        self.__bag_of_words = {}
        
    def __add__(self,other):
        """ Overloading of the "+" operator to join two BagOfWords """
        """ Description: Creates a new bag of words and adds other and self to the new bag """
        """ Return: new bag of words """
        erg = BagOfWords()
...
class Pool(object):
    ...
    def sum_words_in_class(self, dclass):
        ...
        """ Descriptiom: for all the words in vocubalury, finds their sum in dclass """
        sum = 0
    ...
    def learn(self, directory, dclass_name):
        ...
        """ Description: For all teh files in a directory, generate a directory object and add it to __document_classes """
    ...
    def Probability(self, doc, dclass = ""):
        ...
        if dclass:
            ...
            for j in self.__document_classes:
                ...
                prod = 1
                for i in d.Words():
                    wf_dclass = 1 + self.__document_classes[dclass].WordFreq(i) #finds the frequency of a word in dclass for all words in the doc
                    wf = 1 + self.__document_classes[j].WordFreq(i) #finds the frequency of a word in the doc for all words in the doc
